      ...
      <header className="sticky top-0 z-40 backdrop-blur border-b border-neutral-200/70 bg-white/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <a href="#contact" className="inline-flex items-center justify-center px-4 py-2 rounded-2xl text-white bg-[var(--brand-primary)] hover:bg-[var(--brand-hover)] transition-colors">
      ...
      <section id="contact" className="py-16 border-t border-neutral-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <header className="mb-8">
            ...
            <p className="mt-2 text-neutral-600">Tell me about your venues and goals. I’ll reply within one business day.</p>
          </header>
          <div className="rounded-2xl shadow-md bg-white border border-neutral-200">
            <div className="p-6">
              <form className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input className="mt-1 w-full rounded-xl border border-neutral-300 px-3 py-2" placeholder="Your name" />
                </div>
                <div>
                  <label className="text-sm">Email</label>
                  <input type="email" className="mt-1 w-full rounded-xl border border-neutral-300 px-3 py-2" placeholder="you@company.com" />
                </div>
                <div className="md:col-span-2">
                  <label className="text-sm">Message</label>
                  <textarea rows={5} className="mt-1 w-full rounded-xl border border-neutral-300 px-3 py-2" placeholder="What can we help with?" />
                </div>
                <div className="md:col-span-2 flex items-center justify-between">
                  <div className="text-xs text-neutral-500">By submitting, you agree to be contacted about your request.</div>
                  <button type="button" className="inline-flex items-center px-4 py-2 rounded-2xl text-white bg-[var(--brand-primary)] hover:bg-[var(--brand-hover)] transition-colors">
                    Request a Consultation <ArrowRight className="ml-2"/>
                  </button>
                </div>
              </form>
          ...
          <div className="mt-6 text-sm text-neutral-600">
            Prefer email? <a className="underline" href="mailto:info@cinematechgroup.com">info@cinematechgroup.com</a>
          </div>
        </div>
      </section>
