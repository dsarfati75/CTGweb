...
// Paste your FULL data URI into data/cinematech_logo_datauri_full.txt, then run: npm run prepare-logo (for local)
// In Vercel, you already baked it in via the script before deploy
...
function ArrowRight({ className = "w-4 h-4" }) { // unused; safe to keep or delete later
  return (
